...
const ChannelMessageContainer: React.FC<ChannelMessageContainerProps> = ({
    message, isCurrentUser, displayAvatr
}) => {
    return (
    ...
    <div className={`max-w-[300px] rounded-b-[1.9rem] p-4 text-sm text-white/90 relative min-w-[80px] mt-1
    ${isCurrentUser?  "bg-[#59598E] self-end rounded-tl-[1.9rem]":
